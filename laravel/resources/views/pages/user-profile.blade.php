            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="/img/eu.jpg" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                    </div>
                </div>
                    ...
                    <form role="form" method="POST" action={{ route('profile.update') }} enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="postal" mask="wejwçg" value="{{ old('postal', auth()->user()->postal) }}">
                                    </div>
                                </div>
                            </div>
                            <hr class="horizontal dark">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Fale um pouco sobre você</label>
                ...
                <div class="card card-profile">
                    ...
                    <div class="card-header text-center border-0 pt-0 pt-lg-2 pb-4 pb-lg-3">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="javascript:;"
                                class="btn btn-sm btn-dark float-right mb-0 d-none d-lg-block">Mensagem</a>
                    ...
                    <div class="card-body pt-0">
                            ...
                            <div class="col">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <div class="d-grid text-center">
                                        ...
                                        <span class="text-sm opacity-8">Comentários</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="text-center mt-4">
                            <h5>
                                Guilherme Braz<span class="font-weight-light">, 21</span>
                            </h5>
                            <div class="h6 font-weight-300">
                                <i class="ni location_pin mr-2"></i>Maceió, AL
                            </div>
                            <div class="h6 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>Dev Full Stack - PHP/Laravel
                            </div>
                            <div>
                                <i class="ni education_hat mr-2"></i>IFAL - Instituto Federal de Alagoas
                            </div>
                        </div>
                    </div>
                </div>
