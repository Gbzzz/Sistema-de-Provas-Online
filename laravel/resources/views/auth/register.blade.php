            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Cadastro de Usuários</h1>
                        <p class="text-lead text-white">
                            Crie a conta de um novo usuário completando os dados abaixo.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register.perform') }}">
                                ...
                                <div class="flex flex-col mb-3">
                                    <select id="tipoAcesso" class="form-control" aria-label="select" name="tipoAcesso" :value="old('tipoAcesso')" required>
                                ...
                                <div>
                                    ...
                                    <br>
                                        @php
                                            ...
                                            echo $password;
                                        @endphp
                                        <input id="password" value="{{$password}}" class="form-control" type="hidden" name="password" required/>
                                </div>
                                <br>
                                {{-- <div class="form-check form-check-info text-start">
                                    <input class="form-check-input" type="checkbox" name="terms" id="flexCheckDefault" >
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Eu aceito os <a href="javascript:;" class="text-dark font-weight-bolder">
                                ...
                                <p class="text-sm mt-3 mb-0">Já tem cadastro? <a href="{{ route('login') }}"
                                        class="text-dark font-weight-bolder"> Clique aqui</a></p>
                            </form>
                        </div>
                    </div>
                </div>
